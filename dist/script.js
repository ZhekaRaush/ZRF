...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.layout = function (content) {
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.listElement = function (i) {
  const swap = this[i];
...
Object(_lib_lib__WEBPACK_IMPORTED_MODULE_0__["default"])('button').on('click', function () {
  Object(_lib_lib__WEBPACK_IMPORTED_MODULE_0__["default"])('div').listElement(2).toggleClass('active');
});
...
console.log(Object(_lib_lib__WEBPACK_IMPORTED_MODULE_0__["default"])('div').listElement(2).find('.some'));
